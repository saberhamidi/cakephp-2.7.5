<div class="userAddresses index">
	...
	<tr>
		...
		<td><?php echo h($userAddress['UserAddress']['postal_code']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userAddress['UserAddress']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $userAddress['UserAddress']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
